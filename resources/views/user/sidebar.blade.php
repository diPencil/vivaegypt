...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            <li class="{{ Route::is('user.dashboard') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('user.dashboard') }}"><span class="menu-bar__text">
            ...
            <li class="{{ Route::is('user.orders') || Route::is('user.order_show') ? 'active' : '' }}" style="position:relative">
                <a class="collapsed" href="{{ route('user.orders') }}">
                    <span class="menu-bar__text crancy-sb-flex">
                        <span class="crancy-sb-left">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
                                <svg class="crancy-svg-icon" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M15 16V15H22L20.5 13M22 18V19H15L16.5 21" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                            <span class="menu-bar__name">{{ __('translate.Order list') }}</span>
                        </span>
                        <span class="crancy-sb-badge" data-sb-key="orders">0</span>
                    </span>
                </a>
            </li>
            ...
            <li class="{{ Route::is('user.wishlist.index') || Route::is('user.wishlist.services') ? 'active' : '' }}">
                <a href="#!" class="collapsed" data-bs-toggle="collapse"
                    data-bs-target="#menu-item__wishlist_submenu"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                ...
                <div class="collapse crancy__dropdown {{ Route::is('user.wishlist.index') || Route::is('user.wishlist.services') ? 'show' : '' }}"
                    id="menu-item__wishlist_submenu" data-bs-parent="#CrancyMenu">
            ...
            <li class="{{ Route::is('user.bookings.index') || Route::is('user.bookings.details') ? 'active' : '' }}" style="position:relative">
                <a class="collapsed" href="{{ route('user.bookings.index') }}">
                    <span class="menu-bar__text crancy-sb-flex">
                        ...
                        <span class="crancy-sb-badge" data-sb-key="bookings">0</span>
                    </span>
                </a>
            </li>

            <li class="{{ Route::is('user.agent-support.*') ? 'active' : '' }}" style="position:relative">
                <a class="collapsed" href="{{ route('user.agent-support.index') }}">
                    <span class="menu-bar__text crancy-sb-flex">
                        <span class="crancy-sb-left">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 3H19C20.1046 3 21 3.89543 21 5V13.5C21 14.6046 20.1046 15.5 19 15.5H10.5"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M11 7H18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        ...
                                        stroke-linejoin="round" />
                                    <path
                                        d="M12.5 12.5H6.99015M6.99015 12.5H4.00017C3.44791 12.5 3.0002 12.9477 3.00018 13.4999L3 17M6.99015 12.5L7 17M3 21V17M3 17H7M7 17V21"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </span>
                            <span class="menu-bar__name">{{ __('translate.Agent Support') }}</span>
                        </span>
                        <span class="crancy-sb-badge" data-sb-key="agent_support">0</span>
                    </span>
                </a>
            </li>


            <li class="{{ Route::is('user.support-ticket.*') ? 'active' : '' }}" style="position:relative">
                <a class="collapsed" href="{{ route('user.support-ticket.index') }}">
                    <span class="menu-bar__text crancy-sb-flex">
                        <span class="crancy-sb-left">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10.2419 12.2555C10.2419 10.7377 9.0123 9.50732 7.49538 9.50732C5.97848 9.50732 4.74878 10.7377 4.74878 12.2555C4.74878 13.7732 5.97848 15.0036 7.49538 15.0036C9.0123 15.0036 10.2419 13.7732 10.2419 12.2555Z"
                                        stroke="currentColor" stroke-width="1.5" />
                                    <path
                                        d="M12.9881 21.9985H2.00171C2.00171 19.7909 4.46111 17.5016 7.49491 17.5016C10.5287 17.5016 12.9881 19.7909 12.9881 21.9985Z"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M15.4944 7.01221H15.5025M18.4944 7.01221H18.5025" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="square" />
                                    <path
                                        d="M16.9799 12.0102C19.7514 12.0102 21.9982 9.7697 21.9982 7.00586C21.9982 4.24201 19.7514 2.00146 16.9799 2.00146C14.2084 2.00146 11.9617 4.24201 11.9617 7.00586C11.9617 8.71617 12.9965 10.248 13.9497 10.9756C13.88 11.7125 13.5228 12.4935 13.0049 13.0032C12.9133 13.0933 14.243 12.7049 15.812 11.8587C16.2939 11.9708 16.3293 12.0102 16.9799 12.0102Z"
                                        stroke="currentColor" stroke-width="1.5" />
                                </svg>
                            </span>
                            <span class="menu-bar__name">{{ __('translate.Support Ticket') }}</span>
                        </span>
                        <span class="crancy-sb-badge" data-sb-key="support_ticket">0</span>
                    </span>
                </a>
            </li>
            ...
            <li class="{{ Route::is('user.live-chat.*') ? 'active' : '' }}" style="position:relative">
                <a class="collapsed" href="{{ route('user.live-chat.page') }}">
                    <span class="menu-bar__text crancy-sb-flex">
                        <span class="crancy-sb-left">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <span id="user-lc-badge" class="crancy-sb-badge" data-sb-key="live_chat">0</span>
                    </span>
                </a>
            </li>
            @endif

            <li class="{{ Route::is('user.edit-profile') ? 'active' : '' }}"><a class="collapsed"
            ...
            <li class="{{ Route::is('user.change-password') ? 'active' : '' }}"><a class="collapsed"
            ...
            <li class="{{ Route::is('user.account-delete') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('user.account-delete') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 11.5H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M10.5 15.5H13.5" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path
            ...
            <li><a href="{{ route('user.logout') }}" class="collapsed"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
    ...
    @if ($auth_user->is_seller == 1)
        <div class="d-flex d-md-none justify-content-center pt-5">
            <a href="{{ route('agent.dashboard') }}"
                class="panel-switcher-btn">{{ __('translate.Agent Dashboard') }}</a>
        </div>
    @else
        <div class="d-flex d-md-none justify-content-center pt-5">
            <a href="{{ route('user.create-agent') }}"
                class="panel-switcher-btn">{{ __('translate.Create an agent account') }}</a>
        </div>
    @endif
