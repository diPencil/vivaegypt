...
@section('title')
    <title>{{ __('translate.Create an agent account') }}</title>
@endsection
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Create an agent account') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Create an agent account') }}</p>
@endsection
@section('body-content')
    <form action="{{ route('user.agent-application') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <!-- crancy Dashboard -->
        <section class="crancy-adashboard crancy-show">
            <div class="container container__bscreen">
                <div class="row">
                    ...
                    @if ($user->tour_guide_joining_request == 'pending')
                                    ...
                                    <div class="crancy-product-card">
                                        <div class="alert alert-warning alert-has-icon">
                                            ...
                                            <div class="alert-body">
                                                ...
                                                <p>{{ __('translate.Your agent application under the review. please wait sometimes. you will get notify after the application approval') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    @if ($user->tour_guide_joining_request == 'not_yet' || $user->tour_guide_joining_request == 'rejected')
                        <div class="col-12">
                            <div class="crancy-body">
                                <!-- Dashboard Inner -->
                                <div class="crancy-dsinner">
                                        ...
                                        <div class="col-12 mg-top-30">
                                            ...
                                            <div class="crancy-product-card">
                                                <h4 class="crancy-product-card__title">
                                                    {{ __('translate.Agent Information') }}
                                                </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="crancy__item-form--group mg-top-25 w-100">
                                                            <span
                                                                class="crancy__item-label crancy__item-label-product">{{ __('translate.Agent Logo') }}
                                                                *</span>
                                                            <div
                                                                class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                <input accept="image/*" type="file" class="btn-check"
                                                                    name="agent_logo" id="input-img1" autocomplete="off"
                                                ...
                                                <div class="row">
                                                    <div class="crancy__item-form--group mg-top-25 col-md-6">
                                                        <label
                                                            class="crancy__item-label crancy__item-label-product">{{ __('translate.Agent Name') }}
                                                            * </label>
                                                        <input class="crancy__item-input" type="text" name="agent_name"
                                                            value="{{ old('agent_name') }}">
                                                    </div>
                                                    <div class="crancy__item-form--group mg-top-25 col-md-6">
                                                        <label
                                                            class="crancy__item-label crancy__item-label-product">{{ __('translate.Agent Slug') }}
                                                            * </label>
                                                        <input class="crancy__item-input" type="text" name="agent_slug"
                                                            value="{{ old('agent_slug') }}">
                                                    </div>
                                                ...
                                                <div class="crancy__item-form--group mg-top-25">
                                                    <label
                                                        class="crancy__item-label crancy__item-label-product">{{ __('translate.Agent Description') }}
                                                        *</label>
...
@push('js_section')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const agentSlugInput = document.querySelector('input[name="agent_slug"]');

            agentNameInput.addEventListener('input', function() {
                const slug = agentNameInput.value
                    .toLowerCase()
                    .trim()
