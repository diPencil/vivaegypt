                                                ...
                                                <div class="crancy-theme-card__content p-4">
                                                    ...
                                                    <div class="crancy-theme-card__btn mt-3 d-flex gap-3">
                                                        ...
                                                        @if ($active_theme != $theme_name)
                                                            ...
                                                            <div>
                                                                <a onclick="itemDeleteConfirmation('{{ $theme_name }}')" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn crancy-btn__sm crancy-btn__red">{{ __('translate.Delete') }}</a>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
