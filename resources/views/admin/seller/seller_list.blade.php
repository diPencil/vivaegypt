                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ html_decode($user->agent_name) }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.seller-show', $user->username) }}"
...
@push('js_section')
    <script>
        ...
        $(document).ready(function() {
            // Append the Create Agent button to the DataTables filter area
            var createBtnHtml = `<div class="dt-buttons btn-group flex-wrap me-3">
                                    <a href="{{ route('admin.agent-create') }}" class="crancy-btn crancy-btn--primary" style="padding: 10px 20px; font-size: 14px;">
                                        {{ __('translate.Create New Agent') }}
                                    </a>
                                 </div>`;
            $(".dataTables_filter").append(createBtnHtml);
            $(".dataTables_filter").addClass("d-flex align-items-center justify-content-end gap-3");
            $(".dt-buttons").removeClass("me-3").addClass("ms-3");
        });
