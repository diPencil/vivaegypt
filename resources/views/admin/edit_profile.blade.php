                                ...
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="crancy__item-form--group mg-top-25">
                                                <label class="crancy__item-label crancy__item-label-product">{{ __('translate.WhatsApp Number') }}</label>
                                                <input class="crancy__item-input crancy__item-input--phone" type="tel" name="whatsapp" value="{{ $admin->whatsapp }}" placeholder="+201234567890" autocomplete="tel" dir="ltr" inputmode="tel">
                                            </div>
