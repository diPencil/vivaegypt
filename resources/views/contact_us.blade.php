            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="tg-team-details-contant tg-contact-info-wrap mb-30">
                        ...
                        <p class="mb-25">{{ __('translate.contact_info_desc') }}</p>
                ...
                <div class="col-lg-7">
                    <div class="tg-contact-content-wrap ml-40 mb-30">
                        <h3 class="tg-contact-title mb-15">{{ __('translate.contact_intro_title') }} <br>
                            {{ __('translate.contact_intro_subtitle') }}</h3>
                        <p class="mb-30">
                            {{ __('translate.contact_intro_desc') }}
                        </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="review-checkbox d-flex align-items-center mb-25">
                                            ...
                                            <label for="australia"
                                                class="tg-label">{{ __('translate.contact_save_info') }}</label>
                                        </div>
