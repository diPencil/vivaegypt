                    ...
                    <div class="tg-faq-content-wrap">
                        ...
                        <div class="tg-faq-content">
                            <div class="accordion tg-custom-accordion" id="accordionExample">
                                @php
                                    $faqs = [
                                        ['q' => __('brand.faq_1_q'), 'a' => __('brand.faq_1_a')],
                                        ['q' => __('brand.faq_2_q'), 'a' => __('brand.faq_2_a')],
                                        ['q' => __('brand.faq_3_q'), 'a' => __('brand.faq_3_a')],
                                        ['q' => __('brand.faq_4_q'), 'a' => __('brand.faq_4_a')],
                                        ['q' => __('brand.faq_5_q'), 'a' => __('brand.faq_5_a')],
                                        ['q' => __('brand.faq_6_q'), 'a' => __('brand.faq_6_a')],
                                        ['q' => __('brand.faq_7_q'), 'a' => __('brand.faq_7_a')],
                                        ['q' => __('brand.faq_8_q'), 'a' => __('brand.faq_8_a')],
                                    ];
                                @endphp

                                @foreach ($faqs as $key => $slide)
                                    <div @class([
                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="tg-cta-content">
                                    ...
                                    <h2 class="mb-15 tg-cta-title text-white text-capitalize">
                                        {{ __('brand.app_cta_title') }}
                                    </h2>
                                    <p class="text-white opacity-75 mb-0">
                                        {{ __('brand.app_cta_subtitle') }}
                                    </p>
                                </div>
                            </div>
