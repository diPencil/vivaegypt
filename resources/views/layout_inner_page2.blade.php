...
<head>
    ...
    <style>
        .tg-header-height .header-login-btn {
...
<body class="service_page">
                            ...
                            <form action="{{ route('front.tourbooking.services') }}" method="GET">
                                <div class="search__input">
                                    <input class="search-input-field" type="text"
                                        ...
                                        placeholder="{{ __('translate.Search keyword') }}">
    ...
    <header class="tg-header-height">
        <div class="tg-header__area">
            @include('components.header_top_bar')
                        ...
                        <div class="col-lg-4 col-7">
                            <div
                                ...
                                <div class="tg-header-btn ml-20">
                                    @guest('web')
                                        <a class="tg-btn-header header-login-btn" href="{{ route('user.login') }}">
                                    ...
                                    @else
                                        <a class="tg-btn-header header-login-btn"
                            ...
                            <div class="tg-footer-widget mb-40">
                                ...
                                <div class="tg-footer-form mb-30">
                                    <form action="{{ route('store-newsletter') }}" method="POST">
                                        @csrf
                                        <input type="email" placeholder="{{ __('translate.Enter your mail') }}" name="email">
                                                ...
                                                <span class="mr-15">
                                                    <svg width="20" height="24" viewBox="0 0 20 24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="white" stroke-width="1.73333"
