...
@section('title')
    <title>{{ __('translate.Agent Profile') }}</title>
@endsection
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Agent Profile') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Agent Profile') }}</p>
@endsection
@section('body-content')
    <form action="{{ route('agent.update-agent-profile') }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <!-- crancy Dashboard -->
        <section class="crancy-adashboard crancy-show">
            <div class="container container__bscreen">
                <div class="row">
                    ...
                    <input type="hidden" name="old_agent_logo" value="{{ $user->agent_logo }}">
                                ...
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <h4 class="crancy-product-card__title">{{ __('translate.Agent Information') }}
                                            </h4>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="crancy__item-form--group mg-top-25 w-100">
                                                        ...
                                                        <div
                                                            ...
                                                            <input accept="image/*" type="file" class="btn-check" name="agent_logo"
