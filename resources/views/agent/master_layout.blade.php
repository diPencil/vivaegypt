        ...
        <div class="crancy-smenu" id="CrancyMenu">
            ...
            <div class="admin-menu">
                ...
                <div class="logo crancy-sidebar-padding pd-right-0">
                    <a class="crancy-logo" href="{{ route('agent.dashboard') }}">
                                ...
                                <div class="crancy-header__right">
                                    <div class="crancy-header__group">
                                        <div class="crancy-header__group-two">
                                            <div class="crancy-header__right">
                                                <div
                                                    class="profile-switcher-wrapper d-md-flex d-none gap-3 align-items-center">
                                                    <p class="text">{{ __('translate.Switch to User Dashboard') }}
                                                    </p>
                                                    ...
                                                    <div class="crancy-header__single">
                                                        <a target="_blank" class="crancy-header__blink"
                                                            ...
                                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                                ...
                                                                <ellipse cx="12" cy="12" rx="4"
                                                                    ry="10" stroke="currentColor"
                                                                    stroke-width="1.5" />
                                                                <path
                                                ...
                                                <!-- End Header Option Group -->
                                                    ...
                                                    <div class="crancy-header__single">
                                                        <a href="{{ route('agent.edit-profile') }}">
                                                            <div class="crancy-header__author-img"><img
