                            ...
                            <div class="row row__bscreen">
                                            ...
                                            <span>
                                                <div
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <path d="M15 11H18" stroke="#C62828" stroke-width="1.5"
                                                ...
                                                <div
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#C62828" stroke-width="1.5"></path>
                                                        <path
                                                            ...
                                                            stroke="#C62828" stroke-width="1.5" stroke-linejoin="round">
                                                        </path>
                                                        <path
                                        ...
                                        <div class="flex-main">
                                            <span>
                                                <div
                                                    ...
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="12" cy="12" r="10" stroke="#C62828"
                                                        ...
                                                        <path d="M12 6.5V8" stroke="#C62828" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <path d="M12 16V17.5" stroke="#C62828" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                </div>
                                            </span>
                                ...
                                <div class="col-xxl-3 col-md-6 col-12 mg-top-30">
                                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                                        <div class="flex-main">
                                            <span>
                                                @include('agent.svg.total_active_services')
                                            </span>
                                            <div class="flex-1">
                                                <div class="crancy-ecom-card__heading">
                                                    <div class="crancy-ecom-card__icon">
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($bookings as $booking)
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('agent.tourbooking.bookings.show', $booking->id) }}"
