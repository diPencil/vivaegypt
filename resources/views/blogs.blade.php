                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="tg-blog-grid-wrap tg-blog-lg-spacing mr-50">
                        <div class="row">
                                                ...
                                                <span>
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#C62828" stroke-width="0.977778" stroke-linecap="round"
                                                    ...
                                                    <span>
                                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#C62828" stroke-width="1.06667"
                                            ...
                                            <div class="tg-blog-sidebar-btn">
                                                <a href="{{ route('blog', $blog->slug) }}"
                                                    ...
                                                    <span class="d-flex align-items-center justify-content-center">
                                                        <span class="btn-text">{{ __('translate.Read More') }}</span>
                                                        <span class="btn-icon ml-5">
                                                            <svg width="21" height="16" viewBox="0 0 21 16"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M0.995842 8.00001H19.9456M19.9456 8.00001L12.9707 1.02515M19.9456 8.00001L12.9707 14.9749"
                                                                    stroke="currentColor" stroke-width="1.77778"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                        </span>
                                                        <span class="btn-icon ml-5">
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="empty_state_main">
                                        <div class="empty_state_thumb">
