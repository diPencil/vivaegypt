...
<div class="tg-listing-area pt-120 pb-120 p-relative">
    <img class="tg-listing-su-2-shape p-absolute d-none d-xxl-block"
        src="{{ asset('frontend/assets/img/shape/hill-3.png') }}" alt="">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="tg-listing-section-title-wrap text-center mb-40">
                    <h5 class="tg-section-su-subtitle su-subtitle-2 mb-15 wow fadeInUp" data-wow-delay=".4s"
                        ...
                        {{ getTranslatedValue($theme4_tour_package, 'sub_title') }}
                    </h5>
                    <h2 class="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s"
                        data-wow-duration=".9s">
                        {{ getTranslatedValue($theme4_tour_package, 'title') }}
                    </h2>
                </div>
            </div>
        </div>
        @if ($theme4_popular_services->count() > 0)
            <div class="row">
                @foreach ($theme4_popular_services as $key => $service)
                ...
                <div class="col-12">
                    <div class="text-center mt-15">
                        <a href="{{ getTranslatedValue($theme4_tour_package, 'button_url') }}"
                            class="tg-btn tg-btn-transparent tg-btn-su-transparent">
                            {{ getTranslatedValue($theme4_tour_package, 'button_text') }}
                        </a>
                    </div>
                </div>
            </div>
