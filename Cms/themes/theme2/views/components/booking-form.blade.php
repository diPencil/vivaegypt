...
@if ($theme2_service_type->count() > 0)
    ...
    <div class="tg-booking-form-area tg-grey-bg pb-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="tg-booking-form-wrap tg-booking-form-space" style="overflow: visible !important;">
                        <div class="tg-booking-form-tabs">
                            <div class="nav nav-tab justify-content-center" id="nav-tab" role="tablist">
                                @foreach ($theme2_service_type as $key => $service_type)
                                    <button @class(['nav-links', 'active' => $loop->first])
                        ...
                        <div class="tab-content" id="nav-tabContent" style="overflow: visible !important;">
                            @foreach ($theme2_service_type as $key => $service_type)
                                <div @class(['tab-pane', 'show active' => $loop->first]) id="service_type-{{ $service_type->id }}"
                                    role="tabpanel" aria-labelledby="service_type-{{ $service_type->id }}-tab"
                                    tabindex="0" style="overflow: visible !important;">
                                    <div class="tg-booking-form-item theme2-booking-ref">
                                        <form x-data="bookingForm()" @submit.prevent="submitForm">
                                            <div
                                                class="theme2-booking-fields row g-3 g-lg-4 align-items-end">
                                                <div
                                                    class="col-xl col-lg-6 col-12 tg-booking-form-parent-inner tg-hero-quantity p-relative">
                                                    <span
                                                        class="tg-booking-form-title mb-5">{{ __('translate.Destinations:') }}</span>
                                                    <div class="tg-booking-add-input-field tg-booking-quantity-toggle" style="height: 54px !important; display: flex; align-items: center;">
                                                ...
                                                <div class="col-xl col-lg-6 col-12 tg-booking-form-parent-inner">
                                                    <span
                                                        class="tg-booking-form-title mb-5">{{ __('translate.Check in:') }}</span>
                                                    <div class="tg-booking-add-input-date p-relative">
                                                        <input x-model="check_in" class="input datepicker" style="height: 54px !important; width: 100%;"
                                                            name="theme2_check_in" type="text" placeholder="{{ __("translate.Select Date") }}">
                                                        <span>
                                                ...
                                                <div class="col-xl col-lg-6 col-12 tg-booking-form-parent-inner">
                                                    ...
                                                    <div class="tg-booking-add-input-date p-relative">
                                                        <input x-model="check_out" class="input datepicker" style="height: 54px !important; width: 100%;"
                                                            name="theme2_check_out" type="text" placeholder="{{ __("translate.Select Date") }}">
                                                        <span>
                                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                ...
                                                <div class="col-xl-auto col-lg-12 col-12">
                                                    <div class="tg-booking-form-search-btn mb-0 w-100">
                                                        <button class="bk-search-button theme2-bk-search w-100" type="submit">
                                                            {{ __('translate.Search') }}
