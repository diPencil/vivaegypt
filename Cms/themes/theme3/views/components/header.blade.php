                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-7">
                        <div class="tg-menu-right-action d-flex align-items-center justify-content-end">
                            <div class="tg-header-contact-info d-flex align-items-center">
                                ...
                                <div class="tg-header-contact-number d-none d-xl-block" style="white-space: nowrap;">
                            ...
                            <div class="tg-header-btn ml-20 ps-2">
                                ...
                                <a class="tg-btn-header" href="{{ route('user.login') }}">
                                    ...
                                    <span class="btn-text">{{ __('translate.Login') }}</span>
                                </a>
                                @else
                                <a class="tg-btn-header"
                                    ...
                                    <span class="btn-text">{{ __('translate.Dashboard') }}</span>
                                </a>
                                @endguest
                            </div>
    ...
    <!-- header-area-end -->
<style>
    .td_theme_3 .tgmenu__navbar-wrap .navigation {
        gap: 15px !important;
    }
    .td_theme_3 .navigation > li > a {
        font-size: 15px !important;
        padding: 30px 0 !important;
    }
    .td_theme_3 .tgmenu-1-space {
        margin-left: 20px !important;
    }
    .td_theme_3 .tg-btn-header {
    ...
    .td_theme_3 .tg-btn-header .btn-text {
        max-width: 0;
        overflow: hidden;
    ...
    .td_theme_3 .tg-btn-header:hover {
        gap: 8px;
    }
    .td_theme_3 .tg-btn-header:hover .btn-text {
        max-width: 150px;
        opacity: 1;
    }
    .td_theme_3 .tg-header-btn {
