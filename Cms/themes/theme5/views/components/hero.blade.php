...
<div class="tg-hero-area tg-hero-3-spacing include-bg"
    data-background="{{ asset(getSingleImage($theme5_hero, 'background_image')) }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="tg-hero-3-content text-center mb-50">
                    <h4 class="tg-hero-3-subtitle">{{ getTranslatedValue($theme5_hero, 'sub_title') }}</h4>
                    <h2 class="tg-hero-3-title">{{ getTranslatedValue($theme5_hero, 'title') }}</h2>
                </div>
            </div>
            <div class="col-12">
                            ...
                            <div class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                ...
                                <div class="tg-booking-form-location-list tg-booking-quantity-active">
                                    <ul class="scrool-bar scrool-height pr-5">
                                        @foreach ($theme5_destinations as $key => $destination)
                                            <li
