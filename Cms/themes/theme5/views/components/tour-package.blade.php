@php
    ...
    $theme5_popular_services = popularServices();

@endphp

<!-- tg-listing-area-start -->
<div class="tg-listing-area pt-140 pb-105 p-relative z-index-9">
    <img class="tg-listing-3-shape d-none d-xl-block" src="{{ asset('frontend/assets/img/shape/tree.png') }}"
        alt="">
    <div class="container">
        <div class="row align-items-end">
            ...
            <div class="col-lg-3">
                <div class="tg-location-3-btn text-end wow fadeInUp mb-40" data-wow-delay=".6s" data-wow-duration=".9s">
                    <a href="{{ getTranslatedValue($theme5_tour_package, 'button_url') }}"
        ...
        @if ($theme5_popular_services->count() > 0)
            <div class="row">
                @foreach ($theme5_popular_services as $key => $service)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".{{ $key + 3 }}s"
                        ...
                        <div class="tg-listing-card-item tg-listing-3-card-item mb-25">
                            ...
                            <div class="tg-listing-card-content p-relative">
                                ...
                                <h4 class="tg-listing-card-title mb-0">
                                    <a
