...
@if ($theme1_service_type->count() > 0)
                                        ...
                                        <form x-data="bookingForm()" @submit.prevent="submitForm">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <span class="tg-booking-form-title mb-5">{{ __('brand.search_destination') }}</span>
                                                ...
                                                <div class="tg-booking-form-parent-inner mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5">{{ __('brand.search_checkin') }}</span>
                                                    <div class="tg-booking-add-input-date p-relative">
                                                        <input x-model="check_in" class="input datepicker"
                                                            name="datetime-local" type="text" placeholder="{{ __('brand.search_placeholder_date') }}">
                                                        <span>
                                                ...
                                                <div class="tg-booking-form-parent-inner mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5">{{ __('brand.search_checkout') }}</span>
                                                    <div class="tg-booking-add-input-date p-relative">
                                                        <input x-model="check_out" class="input datepicker"
                                                            name="datetime-local" type="text" placeholder="{{ __('brand.search_placeholder_date') }}">
                                                        <span>
                                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div
                                                    class="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-15">
                                                    <span
                                                        class="tg-booking-form-title mb-5">{{ __('brand.search_guests') }}</span>
                                                    <div class="tg-booking-add-input-field tg-booking-quantity-toggle">
                                                        <div>
                                                            <!-- Show this when no values are selected -->
                                                            <span x-show="!rooms && !adults && !children"
                                                                class="tg-booking-title-value">
                                                                {{ __('brand.search_placeholder_guests') }}
                                                            </span>
    ...
    @push('style_section')
        <style>
            /* Base styles for booking form if needed, RTL moved to theme1-rtl.css */
        </style>
    @endpush
@endif
