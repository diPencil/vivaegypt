...
@if (!empty($home1_banner))
    ...
    <div class="tg-banner-area-two tg-banner-space include-bg"
        data-background="{{ asset('frontend/assets/img/shape/home-2-banner-bg.jpeg') }}">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="tg-video-section-title">
                        <div class="tg-video-btn p-relative mb-25">
                            <a href="{{ getTranslatedValue($home1_banner, 'video_url') }}" class="popup-video pulse">
