                ...
                <div class="col-lg-5">
                    <div class="tg-chose-content mb-25">
                        <div class="tg-chose-section-title mb-30">
                            ...
                            <h2 class="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s" dir="auto">
                                {{ getTranslatedValue($home1_why_choose, 'title') }}
                            </h2>
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".9s" dir="auto">
                                {!! clean(getTranslatedValue($home1_why_choose, 'description')) !!}
                            </p>
                        </div>
                                ...
                                @foreach ($translatedSlides as $key => $slide)
                                    <div class="tg-chose-list d-flex mb-15 wow fadeInUp" data-wow-delay=".6s"
                                        ...
                                        <div class="tg-chose-list-content">
                                            @isset($slide['title'])
                                                <h4 class="tg-chose-list-title mb-5" dir="auto">
                                                    {{ $slide['title'] }}
                                                </h4>
                                            @endisset
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="tg-chose-thumb">
                                    <img class="tg-chose-shape-2 tg-chose-star-2 mb-30 ml-15 d-none d-lg-block"
