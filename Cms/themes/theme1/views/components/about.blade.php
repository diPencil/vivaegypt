                ...
                <div class="col-lg-6 mb-30">
                    <div class="tg-about-content text-center">
                        ...
                        <div class="tg-about-section-title mb-25">
                            <h5 class="tg-section-subtitle wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s" dir="auto">
                                {{ getTranslatedValue($home1_about, 'sub_title') }}
                            </h5>
                            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".7s" dir="auto">
                                {{ getTranslatedValue($home1_about, 'title') }}
                            </h2>
                            <p class="text-capitalize wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".8s" dir="auto">
                                {!! clean(getTranslatedValue($home1_about, 'description')) !!}
                            </p>
                        </div>
                        <div class="tp-about-btn-wrap wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".9s">
                            <a href="{{ getTranslatedValue($home1_about, 'button_url') }}"
                                ...
                                <span class="d-flex align-items-center justify-content-center gap-2">
                                    <span class="btn-text">{{ __('translate.About Us') }}</span>
                                    <span class="btn-icon">
