...
class FrontendFieldService
{
    ...
    protected function processImageUpload($image, array $options = [])
    {
        ...
        /**
         * NOTE: Image resizing is disabled because the GD library is not available on this server.
         * The original image is saved, but generated sizes (thumbnails, etc.) will not be created.
         */
        /*
