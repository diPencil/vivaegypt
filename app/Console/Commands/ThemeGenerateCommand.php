...
class ThemeGenerateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // Create theme.json
        $themeJson = [
            'id' => "vivaegypttravel/{$name}",
            'name' => Str::title($name),
            'namespace' => 'Theme\\' . Str::studly($name) . '\\',
            'author' => 'VivaEgyptTravel Developer',
            'url' => null,
            'version' => '1.0.0',
            'description' => "The {$name} theme for VivaEgyptTravel platform",
            'required_plugins' => []
        ];
...
<head>
    ...
    <title>{{ $seo_setting->title ?? 'VivaEgyptTravel' }}</title>
    <meta name="description" content="{{ $seo_setting->description ?? 'VivaEgyptTravel platform' }}">
    <meta name="keywords" content="{{ $seo_setting->keywords ?? 'vivaegypttravel, theme, travel' }}">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="/">{{ $seo_setting->site_name ?? 'VivaEgyptTravel' }}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/tours">@themetrans('nav_tours')</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <a href="/tours" class="btn btn-light btn-lg mt-3">@themetrans('hero_button')</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h4>About VivaEgyptTravel</h4>
                    <p>VivaEgyptTravel is your premier tour experience platform, offering memorable tours and professional tour guides.</p>
                </div>
                <div class="col-md-4">
                    <h4>Quick Links</h4>
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/tours" class="text-light">Tours</a></li>
                ...
                <div class="col-md-4">
                    ...
                    <address>
                        ...
                        <p><i class="fas fa-envelope me-2"></i> info@vivaegypttravel.com</p>
                    </address>
                </div>
            </div>
            <hr class="bg-light">
            <div class="row">
                <div class="col-12 text-center">
                    <p>&copy; {{ date('Y') }} VivaEgyptTravel. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
