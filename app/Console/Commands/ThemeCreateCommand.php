...
class ThemeCreateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $description = $this->option('description') ?: 'A new theme for VivaEgyptTravel';
...
<head>
    ...
    <title>@yield('title', 'VivaEgyptTravel')</title>
...
@section('title', 'Home - VivaEgyptTravel')
...
<div class="hero-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Welcome to VivaEgyptTravel</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="logo">
                    <a href="/">
                        <img src="{{ asset('themes/' . theme()->current() . '/public/images/logo.png') }}" alt="VivaEgyptTravel Logo">
                    </a>
                </div>
            </div>
            <div class="col-md-9">
...
<footer class="site-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h3>About Us</h3>
                <p>VivaEgyptTravel is your premier tour experience provider.</p>
            </div>
            <div class="col-md-4">
                <h3>Quick Links</h3>
                <ul>
            ...
            <div class="col-md-4">
                <h3>Contact Us</h3>
                <p>Email: info@vivaegypttravel.com</p>
