                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ dashboard_route('admin.privacy-policy', ['lang_code' => $language->lang_code] ) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.update-privacy-policy') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
