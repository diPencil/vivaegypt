...
Route::group(['prefix' => 'staff', 'as' => 'staff.', 'middleware' => ['auth:web', 'CheckStaff', 'CheckStaffRoutePermission']], function () {

    Route::resource('withdraw-list', PaymentWithdrawController::class)->except(['destroy']);
    Route::post('withdraw-approval/{id}', [PaymentWithdrawController::class, 'withdraw_approval'])->name('withdraw-approval');
    Route::post('withdraw-rejected/{id}', [PaymentWithdrawController::class, 'withdraw_rejected'])->name('withdraw-rejected');

    Route::resource('withdraw-methods', WithdrawMethodController::class)->except(['destroy']);
