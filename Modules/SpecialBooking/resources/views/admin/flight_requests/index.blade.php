...
@section('title')
    <title>{{ __('translate.Flight Request List') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Flight Request List') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Special Bookings') }} >> {{ __('translate.Flight Request List') }}</p>
@endsection
                            ...
                            <div class="crancy-table crancy-table--v3 mg-top-30">
                                <div class="crancy-customer-filter">
                                    <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box">
                                        <h4 class="crancy-product-card__title">{{ __('translate.Flight Request List') }}</h4>
                                    </div>
                                </div>
                                    ...
                                    <table class="crancy-table__main crancy-table__main-v3 no-footer" id="dataTable">
                                        <thead class="crancy-table__head">
                                            <tr>
                                                ...
                                                <th class="crancy-table__column-2 crancy-table__h2">{{ __('translate.Departure') }}</th>
                                            ...
                                            @foreach ($requests as $request)
                                                <tr>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        ...
                                                        <br><small>{{ ucfirst($request->trip_type) }}</small>
                                                    </td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">{{ $request->departure_date }}</td>
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        @php($badge = [
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ dashboard_route('admin.special-booking.flight-requests.show', $request->id) }}"
