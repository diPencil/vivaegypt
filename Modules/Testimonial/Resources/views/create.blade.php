...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Content') }} >> {{ __('translate.Create Testimonial') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.testimonial.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="row mg-top-30">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="number" name="rating" id="rating">
                                                    </div>
                                                </div>
