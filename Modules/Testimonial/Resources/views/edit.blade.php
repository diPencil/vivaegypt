...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Content') }} >> {{ __('translate.Edit Testimonial') }}</p>
@endsection
                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ dashboard_route('admin.testimonial.edit', ['testimonial' => $testimonial->id, 'lang_code' => $language->lang_code] ) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.testimonial.update',$testimonial->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.testimonial.index') }}" class="crancy-btn "><i class="fa fa-list"></i> {{ __('translate.Testimonial List') }}</a>
                                            </div>
                                            ...
                                            <div class="row mg-top-30">
                                                            ...
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                ...
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    ...
                                                                    <label class="crancy-image-video-upload__label" for="input-img1">
                                                                        <img id="view_img" src="{{ asset($testimonial->image) }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="number" name="rating" id="rating" value="{{ $testimonial->rating }}">
                                                    </div>
                                                </div>
