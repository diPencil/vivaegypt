                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($blog_comments as $index => $blog_comment)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ dashboard_route('admin.show-comment', $blog_comment->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('translate.Show') }}</a>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ dashboard_url("admin/cms/delete-blog-comment/") }}'+"/"+id)
        }
