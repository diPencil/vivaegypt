...
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        return redirect(dashboard_route('admin.blog.edit', ['blog' => $blog->id, 'lang_code' => admin_lang()]))->with($notify_message);
    ...
    public function destroy($id)
    {
        ...
        $notify_message = array('message' => $notify_message, 'alert-type' => 'success');
        return redirect(dashboard_route('admin.blog.index'))->with($notify_message);
    }
    ...
    public function delete_comment($id){
        ...
        $notify_message = trans('translate.Deleted successfully');
        $notify_message = array('message' => $notify_message, 'alert-type' => 'success');
        return redirect(dashboard_route('admin.comment-list'))->with($notify_message);
    }
