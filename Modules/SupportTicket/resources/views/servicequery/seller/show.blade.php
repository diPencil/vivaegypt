...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Agent Support') }} >> {{ __('translate.Ticket Details') }}</p>
@endsection
                                ...
                                <div class="col-xxl-9 col-12">
                                    <div class="crancy-tdetails mg-top-30">
                                        ...
                                        <div class="crancy-chatbox__explore crancy-chatbox__explore--message m-0">
                                            ...
                                            <form action="{{ route('agent.support-message', $support_ticket->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20 edu_support_files">
                                                            ...
                                                            <input class="form-control h-auto " name="documents[]" type="file" id="formFileMultiple" multiple>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('agent.support-close', $support_ticket->id) }}" class="delet_modal_form" method="POST">
                        @csrf
                        @method('PUT')
