...
@section('title')
    <title>{{ __('translate.Agent Support') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Agent Support') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Agent Support') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box">
                                            <h4 class="crancy-product-card__title">{{ __('translate.Agent Support') }}</h4>

                                            <a href="{{ route('user.agent-support.create') }}" class="crancy-btn "><span>
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($support_tickets as $index => $support_ticket)
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('user.agent-support.show', $support_ticket->ticket_id) }}" class="crancy-btn"><i class="far fa-message"></i> {{ __('translate.Chat') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
