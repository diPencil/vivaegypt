...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Agent Support') }} >> {{ __('translate.Create Ticket') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('user.agent-support.store') }}" method="POST"
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ route('user.agent-support.index') }}" class="crancy-btn "><i
