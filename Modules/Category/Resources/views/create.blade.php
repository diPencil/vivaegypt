...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Tours') }} >> {{ __('translate.Create Category') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.category.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
