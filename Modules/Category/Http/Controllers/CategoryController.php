...
class CategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request)
    {
        ...
        return redirect(dashboard_route('admin.category.edit', ['category' => $category->id, 'lang_code' => admin_lang()]))->with($notify_message);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($listing_qty > 0 || $product_qty > 0) {
            $notify_message = trans('translate.Multiple tours created under it, so you can not delete it');
        ...
        $notify_message=array('message'=>$notify_message,'alert-type'=>'success');
        return redirect(dashboard_route('admin.category.index'))->with($notify_message);
    }
