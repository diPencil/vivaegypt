                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ dashboard_route('admin.brand.edit', ['brand' => $brand->id, 'lang_code' => $language->lang_code] ) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.brand.index') }}" class="crancy-btn "><i class="fa fa-list"></i> {{ __('translate.Brand List') }}</a>
                                            </div>
