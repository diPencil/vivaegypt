...
class BrandController extends Controller
{
    ...
    public function store(BrandRequest $request)
    {
        ...
        return redirect(dashboard_route('admin.brand.index', ['brand' => $brand->id, 'lang_code' => admin_lang()]))->with($notification);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(dashboard_route('admin.brand.index'))->with($notification);
    }
