                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.faq.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.faq.index') }}" class="crancy-btn "><i class="fa fa-list"></i> {{ __('translate.FAQ List') }}</a>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <select class="form-select crancy__item-input" name="faq_type">
                                                            <option value="section_one">{{ __('translate.Section One') }}</option>
                                                            <option value="section_two">{{ __('translate.Section Two') }}</option>
