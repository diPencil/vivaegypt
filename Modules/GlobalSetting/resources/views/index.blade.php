...
<path d="M15 6H18V9M6 12C13 12 17.5 6.5 17.5 6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id-live-chat" role="tab" aria-selected="false">
                                                <span class="crancy-psidebar__icon">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                                </span>
                                                <h4 class="crancy-psidebar__title">{{ __('translate.Live Chat') }}</h4>
                                            </a>
                                    ...
                                    <div class="crancy-ptabs">
                                        ...
                                        <div class="crancy-ptabs__inner">
                                            <div class="tab-content" id="nav-tabContent">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group  mg-top-form-20">
                                                                                            ...
                                                                                            <select class="form-select crancy__item-input" name="timezone">
                                                                                                <option {{ $general_setting->timezone == 'Africa/Abidjan' ? 'selected' : '' }} value="Africa/Abidjan">Africa/Abidjan</option>
                                                ...
                                                <div class="tab-pane fade" id="id-live-chat" role="tabpanel">
                                                    <form action="{{ route('admin.update-live-chat') }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="crancy-ptabs__separate">
                                                                    <div class="crancy-ptabs__form-main">
                                                                        <div class="crancy__item-group">
                                                                            <h3 class="crancy__item-group__title">{{ __('translate.Live Chat') }}</h3>
                                                                            <div class="crancy__item-form--group">
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                                                            ...
                                                                                            <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                                                                <label class="crancy__item-switch">
                                                                                                    <input name="status" {{ isset($general_setting->live_chat_status) && $general_setting->live_chat_status == 1 ? 'checked' : '' }} type="checkbox">
                                                                                                    <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                                </label>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="col-12 mt-3">
                                                                                        <div class="alert alert-info">
                                                                                            <strong>{{ __('translate.Live Chat') }}</strong> —
                                                                                            {{ __('translate.When enabled, a chat widget will appear on the website for logged-in customers to contact you in real time.') }}
                                                                                            <br>
                                                                                            <a href="{{ route('admin.live-chat.index') }}" class="btn btn-sm btn-primary mt-2">
                                                                                                {{ __('translate.View All Conversations') }}
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
...
@push('js_section')
    <script>
        ...
        // Activate the correct settings tab from URL hash
        (function () {
            function activateTabFromHash() {
                var hash = window.location.hash;
                if (!hash) return;
                var trigger = document.querySelector('#list-tab [href="' + hash + '"]');
                if (trigger) {
                    trigger.click();
                    setTimeout(function () {
