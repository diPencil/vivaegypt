...
class GlobalSettingController extends Controller
{
    ...
    public function update_general_setting(GeneralSettingRequest $request)
    {
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id1', $notify_message);
    }
    ...
    public function update_logo_favicon(Request $request)
    {
        ...
        if ($request->logo) {
            ...
            $file_name = 'logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->footer_logo) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'footer-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->footer_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->secondary_logo) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'secondary-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->secondary_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->secondary_footer_logo) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'secondary-footer-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->secondary_footer_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->secondary_navmenu_logo) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'secondary-menu-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->secondary_navmenu_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->home3_logo) {
            ...
            $file_name = 'secondary-menu-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->home3_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->home3_footer_logo) {
            ...
            $file_name = 'secondary-menu-logo-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->home3_footer_logo->move(public_path('uploads/website-images'), $file_name);
        ...
        if ($request->favicon) {
            ...
            $file_name = 'favicon-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $favicon_name = 'uploads/website-images/' . $file_name;
            $request->favicon->move(public_path('uploads/website-images'), $file_name);
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id2', $notify_message);
    }
    ...
    public function update_google_captcha(GoogleRecaptchaRequest $request)
    {
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id3', $notify_message);
    }

    public function update_tawk_chat(TawkChatRequest $request)
    {
        abort_unless(auth('admin')->user()?->isDevAdmin(), 403);
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id4', $notify_message);
    }

    public function update_live_chat(Request $request)
    {
        $value = $request->status ? 1 : 0;

        $exists = GlobalSetting::where('key', 'live_chat_status')->exists();

        if ($exists) {
            GlobalSetting::where('key', 'live_chat_status')->update(['value' => $value]);
        } else {
            \DB::table('global_settings')->insert([
                'key'        => 'live_chat_status',
                'value'      => $value,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id-live-chat', $notify_message);
    }
    ...
    public function update_google_analytic(GoogleAnalyticRequest $request)
    {
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id5', $notify_message);
    }
    ...
    public function update_facebook_pixel(FacebookPixelRequest $request)
    {
        ...
        $notify_message = array('message' => trans('translate.Updated successfully'), 'alert-type' => 'success');
        return $this->redirect_to_tab('id6', $notify_message);
    }
    ...
    public function database_clear()
    {
        ...
        try {
            ...
            $notify_message = array('message' => trans('translate.Database clear successfully'), 'alert-type' => 'success');
            return $this->redirect_to_tab('id7', $notify_message);
        } catch (\Exception $e) {
            ...
            $notify_message = array('message' => 'Database clear failed: ' . $e->getMessage(), 'alert-type' => 'error');
            return $this->redirect_to_tab('id7', $notify_message);
        }
    }
    ...
    public function error_image_update(Request $request)
    {
        ...
        if ($request->error_image) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'error-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->error_image->move(public_path('uploads/website-images'), $file_name);
    ...
    public function login_image_update(Request $request)
    {
        ...
        if ($request->login_page_bg) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'login-bg-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->login_page_bg->move(public_path('uploads/website-images'), $file_name);
            $setting->value = $logo_name;
            $setting->save();
    ...
    public function admin_login_image_update(Request $request)
    {
        ...
        if ($request->admin_login) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'admin-bg-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->admin_login->move(public_path('uploads/website-images'), $file_name);
            $setting->value = $logo_name;
            $setting->save();
    ...
    public function breadcrumb_update(Request $request)
    {
        ...
        if ($request->breadcrumb_image) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'breadcrumb-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->breadcrumb_image->move(public_path('uploads/website-images'), $file_name);
            $setting->value = $logo_name;
            $setting->save();
    ...
    public function default_avatar_update(Request $request)
    {
        ...
        if ($request->default_avatar) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'avatar-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->default_avatar->move(public_path('uploads/website-images'), $file_name);
            $setting->value = $logo_name;
            $setting->save();
    ...
    public function maintenance_mode_update(Request $request)
    {
        ...
        if ($request->maintenance_image) {
            ...
            $ext = $image->getClientOriginalExtension();
            $file_name = 'maintenance-image-' . date('Y-m-d-h-i-s-') . rand(999, 9999) . '.' . $ext;
            $logo_name = 'uploads/website-images/' . $file_name;
            $request->maintenance_image->move(public_path('uploads/website-images'), $file_name);
            $setting->value = $logo_name;
            $setting->save();
    ...
    private function redirect_to_tab(string $hash, array $notify_message)
    {
        $url = route('admin.general-setting') . '#' . $hash;
        return redirect($url)->with($notify_message);
    }
}
