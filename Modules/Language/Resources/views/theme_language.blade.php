                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ dashboard_route('admin.theme-language', ['lang_code' => $language->lang_code] ) }}">
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="pagination mb-3">
                                                @for ($i = 1; $i <= $lastPage; $i++)
                                                    <a href="{{ dashboard_route('admin.theme-language', ['lang_code' => request('lang_code'), 'page' => $i]) }}" 
                            ...
                            <form action="{{ dashboard_route('admin.update-theme-language') }}" method="POST">
                                @csrf
