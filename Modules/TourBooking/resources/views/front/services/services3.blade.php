                    ...
                    <div class="tg-filter-sidebar mb-40 top-sticky">
                        <div class="tg-filter-item">
                            <div class="d-flex justify-content-between align-items-center mb-10">
                                <h4 class="tg-filter-title mb-0">{{ __('translate.Destination') }}</h4>
                                <a class="tg-filter-clear" x-show="isFilterChanged || isBookingFilterChanged"
                                    @click="resetFilters()" href="javascript:void(0);">{{ __('translate.Clear All') }}</a>
                            </div>
                            <div class="tg-filter-booking-form">
                                ...
                                <div class="tg-booking-form-parent-inner mb-5">
                                    ...
                                    <div class="tg-booking-add-input-date p-relative">
                                        <input x-model="bookingForm.checkIn" class="input datepicker" name="check_in"
                                            type="text" placeholder="{{ __("translate.Check in") }}">
                                        <span>
                                ...
                                <div class="tg-booking-form-parent-inner mb-5">
                                    <span class="tg-booking-form-title">{{ __('translate.Check Out:') }}</span>
                                    <div class="tg-booking-add-input-date p-relative">
                                        <input x-model="bookingForm.checkOut" class="input datepicker" name="check_out"
                                            type="text" placeholder="{{ __("translate.Check out") }}">
                                        <span>
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="tg-booking-form-search-btn">
                                    <button @click="searchServices" class="bk-search-button" type="button">{{ __('translate.Search') }}
                                        <span class="ml-5">
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            @include('components.front.currency_dropdown_pill', ['variant' => 'filter'])
                            ...
                            <div x-data="{ showPropertyType: false }">
                                <h4 class="tg-filter-title mb-15">{{ __('translate.Property Type') }}</h4>
                                ...
                                @if (count($serviceTypes) > 4)
                                    <div class="tg-filter-seemore mt-2 cp select-none"
                                        ...
                                        <span class="more" x-text="showPropertyType ? '{{ __('translate.See Less') }}' : '{{ __('translate.See More') }}'"></span>
                                    </div>
                                @endif
                            ...
                            <div x-data="{ showAmenity: false }">
                                ...
                                @if (count($amenities) > 4)
                                    <div class="tg-filter-seemore mt-2 cp select-none"
                                        ...
                                        <span class="more" x-text="showAmenity ? '{{ __('translate.See Less') }}' : '{{ __('translate.See More') }}'"></span>
                                    </div>
                                @endif
                            ...
                            <div x-data="{ showMoreLanguages: false }">
                                ...
                                @if (count($languages) > 4)
                                    <div class="tg-filter-seemore mt-2 cp select-none"
                                        ...
                                        <span class="more" x-text="showMoreLanguages ? '{{ __('translate.See Less') }}' : '{{ __('translate.See More') }}'"></span>
                                    </div>
                                @endif
                            </div>
