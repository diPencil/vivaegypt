...
<li
    class="{{ Route::is('agent.tourbooking.services.index') || Route::is('agent.tourbooking.services.create') || Route::is('agent.tourbooking.services.edit') ? 'active' : '' }}">
    ...
    <!-- Dropdown Menu -->
    <div class="collapse crancy__dropdown {{ Route::is('agent.tourbooking.services.index') || Route::is('agent.tourbooking.services.create') || Route::is('agent.tourbooking.services.edit') ? 'show' : '' }}"
        id="menu-item__booking_services_list" data-bs-parent="#CrancyMenu">
        <ul class="menu-bar__one-dropdown">
            <li><a href="{{ route('agent.tourbooking.services.index') }}"><span class="menu-bar__text"><span
                            class="menu-bar__name">{{ __('translate.Booking Services') }}</span></span></a></li>

            <li><a href="{{ route('agent.tourbooking.services.create') }}"><span class="menu-bar__text"><span
...
<li
    class="{{ Route::is('agent.tourbooking.destinations.index') || Route::is('agent.tourbooking.destinations.create') || Route::is('agent.tourbooking.destinations.edit') ? 'active' : '' }}">
    <a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__destination_list"><span
            ...
            class="crancy__toggle"></span></a></span>
    <!-- Dropdown Menu -->
    <div class="collapse crancy__dropdown {{ Route::is('agent.tourbooking.destinations.index') || Route::is('agent.tourbooking.destinations.create') || Route::is('agent.tourbooking.destinations.edit') ? 'show' : '' }}"
        id="menu-item__destination_list" data-bs-parent="#CrancyMenu">
        <ul class="menu-bar__one-dropdown">

            <li><a href="{{ route('agent.tourbooking.destinations.index') }}"><span class="menu-bar__text"><span
                            class="menu-bar__name">{{ __('translate.Destinations') }}</span></span></a></li>

            <li><a href="{{ route('agent.tourbooking.destinations.create') }}"><span class="menu-bar__text"><span
                            class="menu-bar__name">{{ __('translate.Create Destination') }}</span></span></a></li>
        </ul>
    </div>
</li>

<li class="{{ Route::is('agent.tourbooking.bookings.index') ? 'active' : '' }}">
    <a class="collapsed" href="{{ route('agent.tourbooking.bookings.index') }}">
