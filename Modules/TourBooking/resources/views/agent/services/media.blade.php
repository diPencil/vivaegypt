                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <form
                                                                    action="{{ route('agent.tourbooking.services.media.store', $service->id) }}"
                                                            ...
                                                            <div class="media-item">
                                                                ...
                                                                <div class="media-item-actions">
                                                                    @if ($media->file_type == 'image' && !$media->is_thumbnail)
                                                                        <form
                                                                            action="{{ route('agent.tourbooking.services.media.set-thumbnail', $media->id) }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('agent.tourbooking.services.media.destroy', $media->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
