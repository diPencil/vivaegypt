                                ...
                                <div class="col-12 mg-top-30">
                                    <div class="crancy-product-card">
                                        <div class="create_new_btn_inline_box">
                                            ...
                                            <div>
                                                <a href="{{ route('agent.tourbooking.services.edit', $service->id) }}"
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <form
                                                                    action="{{ route('agent.tourbooking.services.extra-charges.store', $service->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                            ...
                                                            <div class="modal fade" id="editModal{{ $charge->id }}"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('agent.tourbooking.services.extra-charges.update', $charge->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-bs-dismiss="modal">{{ __('translate.Cancel') }}</button>
                                                                            <form
                                                                                action="{{ route('agent.tourbooking.services.extra-charges.destroy', $charge->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
