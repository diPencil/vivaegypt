...
@push('style_section')
    ...
    <style>
        ...
        .availability-edit-modal .modal-dialog {
        ...
        .availability-edit-modal details.availability-hint-collapsible summary {
            cursor: pointer;
        }
                                    ...
                                    <div class="crancy-product-card">
                                        <div class="create_new_btn_inline_box">
                                            ...
                                            <div>
                                                ...
                                                <a href="{{ route('agent.tourbooking.services.index') }}"
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <form
                                                                    action="{{ route('agent.tourbooking.services.availability.store', $service->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <p class="small text-muted mb-0 mg-top-form-20">
                                                                                {{ __('translate.Availability time slot help') }}
                                                                            </p>
                                                                        </div>
                                                    ...
                                                    <table class="table" id="availabilityTable">
                                                        ...
                                                        <tbody>
                                                            @forelse($service->availabilities->sortBy('date') as $availability)
                                                                ...
                                                                <!-- Edit Modal -->
                                                                <div class="modal fade availability-edit-modal"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('agent.tourbooking.services.availability.update', $availability->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('PUT')
                                                                                <div class="modal-body">
                                                                                    <div class="row">
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    type="text"
                                                                                                    name="date"
                                                                                                    value="{{ $availability->date instanceof \Carbon\Carbon ? $availability->date->format('Y-m-d') : \Carbon\Carbon::parse($availability->date)->format('Y-m-d') }}"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <details
                                                                                                class="availability-hint-collapsible small text-muted mb-0">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Notes') }}</label>
                                                                                                <textarea class="crancy__item-input" name="notes" rows="2">{{ $availability->notes }}</textarea>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-bs-dismiss="modal">{{ __('translate.Cancel') }}</button>
                                                                                <form
                                                                                    action="{{ route('agent.tourbooking.services.availability.destroy', $availability->id) }}"
                                                                                    method="POST">
                                                                                    @csrf
                                                                                    @method('DELETE')
                                                                                    <button type="submit"
    ...
    <div class="modal fade" id="bulkAddModal" tabindex="-1" aria-labelledby="bulkAddModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.tourbooking.services.availability.store', $service->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mg-top-form-20">
                                <div class="crancy__item-form--group">
                                    ...
                                    <input class="crancy__item-input" type="time" name="start_time" step="60">
                                </div>
                            </div>
                            <div class="col-md-6 mg-top-form-20">
                                <div class="crancy__item-form--group">
                                    <label class="crancy__item-label">{{ __('translate.End Time') }}</label>
                                    <input class="crancy__item-input" type="time" name="end_time" step="60">
                                </div>
                            </div>
