                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('agent.tourbooking.services.edit', ['service' => $service->id, 'lang_code' => $language->lang_code]) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <div class="crancy-dsinner">
                            <form
                                action="{{ route('agent.tourbooking.services.update', ['service' => $service->id, 'lang_code' => $lang_code]) }}"
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <select class="crancy__item-input select2" name="amenities[]"
                                                            ...
                                                            @foreach ($amenities as $amenity)
                                                                @php($amenityTrans = $amenity->translation)
                                                                @continue($amenityTrans === null)
                                                                <option value="{{ $amenityTrans->id }}"
                                                                    @selected(is_array($translation->amenities ?? null) && in_array($amenityTrans->id, $translation->amenities ?? []))>
                                                                    {{ $amenityTrans->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <div class="col-12 mg-top-30">
                                        <div class="alert alert-info">
                                            ...
                                            <a href="{{ route('agent.tourbooking.services.media', $service->id) }}"
