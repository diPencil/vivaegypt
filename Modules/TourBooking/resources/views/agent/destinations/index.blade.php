                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="{{ route('agent.tourbooking.destinations.create') }}"
                                            ...
                                            @forelse($destinations as $destination)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        ...
                                                        <a href="{{ route('agent.tourbooking.destinations.edit', $destination) }}"
                                                            class="crancy-action__btn crancy-action__edit crancy-btn">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="{{ route('agent.tourbooking.destinations.show', $destination) }}"
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ url('agent/tourbooking/destinations') }}' + "/" + id)
        }
        ...
        function manageStatus(id) {
            ...
            $.ajax({
                ...
                url: "{{ route('agent.tourbooking.destinations.update-status', ':id') }}".replace(':id', id),
        ...
        function manage{{ __('translate.Featured') }}(id) {
            ...
            $.ajax({
                ...
                url: "{{ route('agent.tourbooking.destinations.update-featured', ':id') }}".replace(':id', id),
                success: function(response) {
                    toastr.success(response.message)
                },
                error: function(err) {
