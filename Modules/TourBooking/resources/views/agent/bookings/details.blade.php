                                        ...
                                        <div class="ed-invoice-main-wrapper">
                                            ...
                                            <div class="ed-invoice-page">
                                                <div class="ed-inv-logo-area">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('agent.tourbooking.bookings.index') }}"
                                                        ...
                                                        @endif
                                                        <a href="{{ route('agent.tourbooking.bookings.invoice', $booking->id) }}"
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.tourbooking.bookings.confirm', ['id' => $booking->id]) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.tourbooking.bookings.cancel', ['id' => $booking->id]) }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    <div class="modal fade" id="addNoteModal" tabindex="-1" aria-labelledby="addNoteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.tourbooking.bookings.add-note', $booking->id) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="paymentStatusModal" tabindex="-1" aria-labelledby="paymentStatusModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.tourbooking.bookings.payment-status', ['booking' => $booking]) }}"
                    method="POST">
                    @csrf
                    <div class="modal-body">
