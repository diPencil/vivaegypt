...
<head>
    ...
    @include('components.front.google_analytic')

    @include('components.front.pixel_status')
...
<body>
    ...
    @include('components.front.backtotop')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="tg-header-top-info d-flex align-items-center">
                                ...
                                <a href="mailto:info@VivaEgyptTravel.com"><i class="mr-5 fa-regular fa-envelope"></i>
                                    info@VivaEgyptTravel.com</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="tg-header-top-info d-flex align-items-center justify-content-end">
                                <a href="tel:+123595966"><i class="fa-sharp fa-regular fa-phone"></i> +123 5959 66</a>
                                <span class="tg-header-dvdr mr-10 ml-10"></span>
                                <a href="login.html"><i class="fa-regular fa-user"></i> {{ __('translate.Login') }} </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tgmenu__wrap d-flex align-items-center">
                                ...
                                <nav class="tgmenu__nav  ml-90 d-none d-xl-block">
                                    <div
                                        ...
                                        <ul class="navigation">
                                            <li class="menu-item-has-children"><a href="index.html"> {{ __('translate.Home') }} </a>
                                                <ul class="sub-menu">
                                            ...
                                            <li class="active menu-item-has-children"><a
                                                    href="hotel-grid.html">Features</a>
                                                <ul class="sub-menu">
                                                    <li class="active"><a href="hotel-grid.html">Hotel Grid</a></li>
                                            ...
                                            <li class="menu-item-has-children"><a href="#">Pages</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="cart.html"> {{ __('translate.Cart') }} </a></li>
                                                    <li><a href="checkout.html"> {{ __('translate.Checkout') }} </a></li>
                                                    <li><a href="pricing.html"> {{ __('translate.Pricing') }} </a></li>
                                                    <li><a href="faq.html"> {{ __('translate.Faq') }} </a></li>
                                                    <li><a href="login.html"> {{ __('translate.Log In') }} </a></li>
                                                    <li><a href="register.html"> {{ __('translate.Register') }} </a></li>
                                                    <li><a href="error.html">Error</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item-has-children"><a href="blog-grid.html"> {{ __('translate.Blogs') }} </a>
                                                <ul class="sub-menu">
                                    ...
                                    <div class="minicart">
                                        ...
                                        <div
                                            ...
                                            <div class="cart-img-info  d-flex align-items-center">
                                                ...
                                                <div class="cart-content">
                                                    <h5 class="cart-title"><a href="shop.html">Halo Smartwatch</a>
                                                    </h5>
                                        ...
                                        <div class="minicart-btn">
                                            ...
                                            <a class="cart-btn cart-btn-black"
                                                href="checkout.html"><span> {{ __('translate.Checkout') }} </span></a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="tgmobile__menu">
            <nav class="tgmobile__menu-box">
                ...
                <div class="tgmobile__search">
                    <form action="#">
                        <input type="text" placeholder="{{ __('translate.Search here...') }}">
    ...
    <!-- footer-area-start -->
    <footer>
        <div class="tg-footer-area pt-130 include-bg" data-background="assets/img/footer/footer-2.jpg">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="tg-footer-widget mb-40">
                                ...
                                <p class="mb-20">Pharetra maecenas felis vestibulum convallis mollis nullam congue
                                    sit.d rivers of Finland Quebec.</p>
                                <div class="tg-footer-form mb-30">
                                    <form action="#">
                                        <input type="email" placeholder="{{ __('translate.Enter your mail') }}">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="tg-footer-widget tg-footer-link ml-80 mb-40">
                                ...
                                <ul>
                                    <li><a href="index.html"> {{ __('translate.Home') }} </a></li>
                                    <li><a href="about.html"> {{ __('translate.About Us') }} </a></li>
                                    <li><a href="#">Services</a></li>
                                    <li><a href="#">Tour Guide</a></li>
                                    <li><a href="contact.html"> {{ __('translate.Contact Us') }}</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
            ...
            <div class="tg-footer-copyright text-center">
                <span>
                    Copyright <a href="#">©VivaEgyptTravel</a> | All Right Reserved
                </span>
            </div>
        </div>
    </footer>
    ...
    @include('components.front.tawk-status')

    @include('components.front.live-chat-widget')

    @include('components.front.cookie-consent')
