                                    ...
                                    <table class="crancy-table__main crancy-table__main-v3  no-footer" id="dataTable">
                                        <thead class="crancy-table__head">
                                            <tr>
                                                ...
                                                <th class="crancy-table__column-2 crancy-table__h2 sorting">
                                                    {{ __('translate.Type / Source') }}</th>
                                                <th class="crancy-table__column-2 crancy-table__h2 sorting">
                                                    {{ __('translate.Customer') }}</th>
                                                <th class="crancy-table__column-2 crancy-table__h2 sorting">
                                            ...
                                            @foreach ($bookings as $booking)
                                                @php
                                                    $bookingStatusLabel = match ($booking->status) {
                                                        ...
                                                        'contacted' => __('translate.Contacted'),
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <span class="crancy-badge" style="background-color: #f0f0f0; color: #333; padding: 2px 6px; border-radius: 4px; font-weight: bold; font-size: 0.85em;">{{ $booking->type }}</span>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <div><strong>{{ $booking->customer_name }}</strong></div>
                                                        <div style="font-size: 0.85em; color: #666;">{{ $booking->customer_email }}</div>
                                                        <div style="font-size: 0.85em; color: #666;">{{ $booking->customer_phone }}</div>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        {{ Str::limit($booking->service, 50) }}
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        {{ currency($booking->amount) }}
                                                        <div style="font-size: 0.8em; color: #888; margin-top: 2px;">{{ $booking->payment_status }}</div>
                                                    </td>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ dashboard_url('admin/tourbooking/bookings') }}' + "/" + id)
        }
