...
<body>
    <div class="print-button">
        ...
        <a href="{{ dashboard_route('admin.tourbooking.bookings.download-invoice', [$booking]) }}">
    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div class="logo-container">
                <img src="{{ asset($general_setting->secondary_logo ?? 'uploads/default.png') }}" alt="Company Logo">
        ...
        <div class="invoice-body">
            <div class="tour-details">
                ...
                <p>{{ __('translate.Tour Type') }}:
                    {{ $booking->service->serviceType->localized_name }}</p>
