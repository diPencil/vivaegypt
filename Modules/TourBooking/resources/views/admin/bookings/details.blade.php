...
@section('body-content')
    @php
        $bookingStatusLabel = __('translate.' . ucfirst($booking->booking_status));
        $paymentStatusLabel = __('translate.' . ucfirst($booking->payment_status));
        $paymentMethodLabel = __('translate.' . ucfirst($booking->payment_method));
    @endphp
    <!-- crancy Dashboard -->
                                        ...
                                        <div class="ed-invoice-main-wrapper">
                                            ...
                                            <div class="ed-invoice-page">
                                                <div class="ed-inv-logo-area">
                                                    ...
                                                    <div>
                                                        <a href="{{ dashboard_route('admin.tourbooking.bookings.index') }}"
                                                        ...
                                                        <a href="#" class="crancy-btn crancy-btn__success"
                                                            ...
                                                            {{ __('translate.Change Payment Status') }}
                                                        </a>
                                                        ...
                                                        @endif
                                                        <a href="{{ dashboard_route('admin.tourbooking.bookings.invoice', [$booking->id]) }}"
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ dashboard_route('admin.tourbooking.bookings.confirm', ['id' => $booking->id]) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ dashboard_route('admin.tourbooking.bookings.cancel', ['id' => $booking->id]) }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    <div class="modal fade" id="addNoteModal" tabindex="-1" aria-labelledby="addNoteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ dashboard_route('admin.tourbooking.bookings.add-note', [$booking->id]) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <div class="modal fade" id="paymentStatusModal" tabindex="-1" aria-labelledby="paymentStatusModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ dashboard_route('admin.tourbooking.bookings.payment-status', ['booking' => $booking]) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="payment_status" required>
                                <option value="">{{ __('translate.Select Payment Status') }}</option>
                                <option value="pending">{{ __('translate.Pending') }}</option>
                                <option value="confirmed">{{ __('translate.Confirmed') }}</option>
