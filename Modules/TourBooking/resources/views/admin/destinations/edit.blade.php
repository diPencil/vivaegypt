                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li>
                                                        <a
                                                            href="{{ dashboard_route('admin.tourbooking.destinations.edit', ['destination' => $destination->id, 'lang_code' => $language->lang_code]) }}">
        ...
        <div class="container container__bscreen">
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.tourbooking.destinations.update', [$destination]) }}" method="POST"
                                    ...
                                    <div class="col-12 mg-top-30">
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.tourbooking.destinations.index') }}"
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                            id="name"
                                                            value="{{ old('name', $t->name ?? $destination->name) }}"
                                                            required>
                                                        @error('name')
                                                ...
                                                @if (admin_lang() == $current_lang)
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input
                                                                placeholder="{{ __('translate.Separator by comma. Ex: 01 Tour, 02 Hotel') }}"
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input summernote" name="description"
                                                            rows="6">{{ old('description', $t->description ?? $destination->description) }}</textarea>
                                                        @error('description')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text"
                                                            name="meta_title"
                                                            value="{{ old('meta_title', $t->meta_title ?? $destination->meta_title) }}">
                                                        @error('meta_title')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input summernote"
                                                            name="meta_description"
                                                            rows="3">{{ old('meta_description', $t->meta_description ?? $destination->meta_description) }}</textarea>
