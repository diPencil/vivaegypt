...
@section('title')
    <title>{{ __('translate.Create Service Type') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Create Service Type') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Tour Booking') }} >> {{ __('translate.Create Service Type') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.tourbooking.service-types.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Create Service Type') }}</h4>

                                                <a href="{{ dashboard_route('admin.tourbooking.service-types.index') }}" class="crancy-btn "><i class="fa fa-list"></i> {{ __('translate.Service Type List') }}</a>
                                            </div>
                                            ...
                                            <div class="row mg-top-30">
                                                <div class="col-12 col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name" id="name" required value="{{ old('name') }}">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="slug" id="slug" required value="{{ old('slug') }}">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="icon" value="{{ old('icon') }}">
                                            ...
                                            <button class="crancy-btn mg-top-25" type="submit">{{ __('translate.Create') }}</button>
