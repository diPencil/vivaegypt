                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.tourbooking.service-types.create') }}"
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($serviceTypes as $serviceType)
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ dashboard_route('admin.tourbooking.service-types.edit', ['service_type' => $serviceType->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-action__btn crancy-action__edit crancy-btn"><i
                                                                class="fa fa-edit"></i>
                                                            {{ __('translate.Edit') }}
                                                        </a>
                                                        <a href="{{ dashboard_route('admin.tourbooking.service-types.show', [$serviceType->id]) }}"
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ dashboard_url('admin/tourbooking/service-types') }}' + "/" + id)
        }
    </script>
@endpush
