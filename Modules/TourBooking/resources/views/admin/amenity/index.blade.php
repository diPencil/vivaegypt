                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="{{ dashboard_route('admin.tourbooking.amenities.create') }}"
                                        ...
                                        <tbody class="crancy-table__body">
                                            @forelse($amenities as $aminity)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ dashboard_route('admin.tourbooking.amenities.edit', ['amenity' => $aminity->id, 'lang_code' => admin_lang()]) }}"
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ dashboard_url('admin/tourbooking/amenities') }}' + "/" + id)
        }
        ...
        function manageStatus(id) {
            ...
            $.ajax({
                ...
                url: "{{ dashboard_route('admin.tourbooking.amenities.update-status', ':id') }}".replace(':id', id),
