...
@section('title')
    <title>{{ __('translate.Create Amenity') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Create Amenity') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Tour Booking') }} >> {{ __('translate.Create Amenity') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        <div class="crancy-dsinner">
                            <form action="{{ dashboard_route('admin.tourbooking.amenities.store') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ dashboard_route('admin.tourbooking.amenities.index') }}"
                                            ...
                                            <div class="row mg-top-30">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group w-100 h-100">
                                                        <label
                                                            class="crancy__item-label">{{ __('translate.Featured Image') }}</label>
                                                        <div
                                    ...
                                    <div class="col-12 mg-top-30">
                                        <button class="crancy-btn"
                                            type="submit">{{ __('translate.Create Amenity') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
