                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <form method="GET" action="{{ dashboard_route('admin.tourbooking.services.index') }}"
                                            ...
                                            <a href="{{ dashboard_route('admin.tourbooking.services.create') }}" class="crancy-btn"><i
                                                    class="fa fa-plus"></i>
                                                        ...
                                                        <div class="dropdown" style="display: inline;">
                                                            ...
                                                            <ul class="dropdown-menu"
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="{{ dashboard_route('admin.tourbooking.services.itineraries', [$service->id]) }}">{{ __('translate.Itineraries') }}</a>
                                                                </li>
                                                                @if ($service->is_per_person)
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ dashboard_route('admin.tourbooking.services.extra-charges', [$service->id]) }}">{{ __('translate.Extra Charges') }}</a>
                                                                    </li>
                                                                @endif
                                                                <li><a class="dropdown-item"
                                                                        href="{{ dashboard_route('admin.tourbooking.services.availability', [$service->id]) }}">{{ __('translate.Availability') }}</a>
                                                                </li>
                                                                <li><a class="dropdown-item"
                                                                        href="{{ dashboard_route('admin.tourbooking.services.media', [$service->id]) }}">{{ __('translate.Media Gallery') }}</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ dashboard_url('admin/tourbooking/services/') }}' + "/" + id)
        }
    </script>
@endpush
