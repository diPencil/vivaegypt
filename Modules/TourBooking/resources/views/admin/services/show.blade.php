                                    ...
                                    <div class="service-detail-card">
                                        <div class="service-detail-header">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @if ($service->is_featured)
                                                    <span class="feature-badge feature-featured">{{ __('translate.Featured') }}</span>
                                                @endif

                                                @if ($service->is_popular)
                                                    <span class="feature-badge feature-popular">{{ __('translate.Popular') }}</span>
                                                @endif

                                                @if ($service->show_on_homepage)
                                                    <span class="feature-badge feature-homepage">{{ __('translate.Homepage') }}</span>
                                                @endif

                                                @if ($service->is_new)
                                                    <span class="feature-badge feature-new">{{ __('translate.New') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="action-buttons">
                                            <div class="btn-group gap-3">
                                                ...
                                                <a href="{{ dashboard_route('admin.tourbooking.services.media', [$service->id]) }}"
                                                    class="crancy-btn crancy-btn--info">
                            ...
                            <div class="row">
                                    ...
                                    <div class="service-detail-card">
                                        ...
                                        <div class="service-detail-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->slug ?: __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->serviceType->localized_name ?? __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Destination') }}</div>
                                                        <div class="detail-value">
                                                            {{ $service->destination->name ?? __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Location') }}</div>
                                                        <div class="detail-value">{{ $service->location ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->duration ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->group_size ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->room_count ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Adult Count') }}</div>
                                                        <div class="detail-value">{{ $service->adult_count ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Children Count') }}
                                                        </div>
                                                        <div class="detail-value">
                                                            {{ $service->children_count ?: __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    {!! $service->short_description ?: '<span class="empty-value">' . __('translate.No short description') . '</span>' !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    {!! $service->description ?: '<span class="empty-value">' . __('translate.No description') . '</span>' !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-12 mg-top-30">
                                    ...
                                    @if ($service->media->count() > 0)
                                        <div class="service-detail-card">
                                            <div class="service-detail-header">
                                                <h4>{{ __('translate.Media Preview') }}</h4>
                                            </div>
                                            <div class="service-detail-body">
                                    ...
                                    <div class="service-detail-card">
                                        ...
                                        <div class="service-detail-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Check-in Time') }}
                                                        </div>
                                                        <div class="detail-value">
                                                            {{ $service->check_in_time ?: __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Check-out Time') }}
                                                        </div>
                                                        <div class="detail-value">
                                                            {{ $service->check_out_time ?: __('translate.Not set') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Ticket') }}</div>
                                                        <div class="detail-value">{{ $service->ticket ?: __('translate.Not set') }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            @if ($service->video_url)
                                                                <a href="{{ $service->video_url }}"
                                                                    target="_blank">{{ $service->video_url }}</a>
                                                            @else
                                                                {{ __('translate.Not set') }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="detail-item">
                                                    ...
                                                    <div class="detail-value">
                                                        @foreach ($service->translation->amenities as $amenityId)
                                                            @php
                                                                $amenity = \Modules\TourBooking\App\Models\Amenity::find(
                                                                    $amenityId,
                                                                );
                                                            @endphp
                                                            @if ($amenity)
                                                                <span
                                                                    class="amenity-tag">{{ $amenity->translation->name ?? $amenity->name }}</span>
                                                            @endif
                                                        @endforeach
                                                    </div>
                                                </div>
                                            ...
                                            @if ($service->tour_plan_sub_title)
                                                <div class="detail-item">
                                                    <div class="detail-label">{{ __('translate.Tour Plan Sub Title') }}
                                                    </div>
                                    ...
                                    <div class="service-detail-card">
                                        ...
                                        <div class="service-detail-body">
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    {!! $service->address ? nl2br(e($service->address)) : '<span class="empty-value">' . __('translate.Not provided') . '</span>' !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    ...
                                                    @else
                                                        <span class="empty-value">{{ __('translate.Not provided') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="detail-value">
                                                    @if ($service->website)
                                                        <a href="{{ $service->website }}"
                                                            target="_blank">{{ $service->website }}</a>
                                                    @else
                                                        <span class="empty-value">{{ __('translate.Not provided') }}</span>
                                                    @endif
                                                </div>
                                            ...
                                            @if ($service->google_map_sub_title)
                                                <div class="detail-item">
                                                    <div class="detail-label">{{ __('translate.Google Map Sub Title') }}
                                                    </div>
                                            ...
                                            @if ($service->google_map_url)
                                                <div class="detail-item">
                                                    <div class="detail-label">{{ __('translate.Google Map URL') }}</div>
                                                    <div class="detail-value">
                                                        <a href="{{ $service->google_map_url }}" target="_blank">{{ __('translate.View on Google Maps') }}</a>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="service-detail-card">
                                        ...
                                        <div class="service-detail-body">
                                            ...
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    {!! $service->seo_description ?: '<span class="empty-value">' . __('translate.Not set') . '</span>' !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-item">
                                                ...
                                                <div class="detail-value">
                                                    {{ $service->seo_keywords ?: __('translate.Not set') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
