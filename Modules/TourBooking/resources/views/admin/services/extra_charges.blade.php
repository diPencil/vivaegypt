                                ...
                                <div class="col-12 mg-top-30">
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($extraChargeLocales as $language)
                                                    <li><a
                                                            href="{{ dashboard_route('admin.tourbooking.services.extra-charges', ['service' => $service->id, 'lang_code' => $language->lang_code]) }}">
                                        ...
                                        @php
                                            $edited_language = $extraChargeLocales->where('lang_code', $lang_code)->first();
                                        @endphp
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <form
                                                                    action="{{ dashboard_route('admin.tourbooking.services.extra-charges.store', ['service' => $service->id, 'lang_code' => $lang_code]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                        ...
                                                        @else
                                                            <div class="accordion-body">
                                                                <div class="alert alert-info mb-0">
                                                                    {{ __('translate.Create extra charge rows in English first, then use this language tab to translate existing extra charges.') }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                    </div>
                                            ...
                                            <table id="crancy-table__vendor">
                                                ...
                                                <tbody>
                                                    @forelse($service->extraCharges as $charge)
                                                        @php
                                                            $chargeName = $charge->translated('name', $lang_code);
                                                            $chargeDescription = $charge->translated('description', $lang_code);
                                                        @endphp
                                                        <tr>
                                                            <td>
                                                                ...
                                                                @if ($chargeDescription)
                                                                    <div class="small text-muted">
                                                                        {{ Str::limit($chargeDescription, 50) }}</div>
                                                                @endif
                                                            </td>
                                                            ...
                                                            <div class="modal fade" id="editModal{{ $charge->id }}"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ dashboard_route('admin.tourbooking.services.extra-charges.update', ['charge' => $charge->id, 'lang_code' => $lang_code]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <input type="hidden" name="lang_code"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div
                                                                                            ...
                                                                                            <label
                                                                                                class="crancy__item-label">{{ __('translate.Description') }}</label>
                                                                                            <textarea class="crancy__item-input summernote" name="description" rows="3">{{ $chargeDescription }}</textarea>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-bs-dismiss="modal">{{ __('translate.Cancel') }}</button>
                                                                            <form
                                                                                action="{{ dashboard_route('admin.tourbooking.services.extra-charges.destroy', [$charge->id]) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
