...
final class Destination extends Model
{
    ...
    /**
     * Name for the active app locale (front uses Session/middleware locale).
     */
    public function getLocalizedNameAttribute(): string
    {
        ...
        if (!$name || $name === $this->name) {
            $translated = __('translate.' . $this->name);
            if ($translated !== 'translate.' . $this->name) {
                return $translated;
            }
        }

        return ($name !== null && $name !== '') ? $name : $this->name;
    }
