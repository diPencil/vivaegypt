...
final class ExtraCharge extends Model
{
    ...
    {
        return $this->hasMany(ExtraChargeTranslation::class);
    }

    public function translation(): HasOne
    {
        return $this->hasOne(ExtraChargeTranslation::class)
            ->where('locale', app()->getLocale())
            ->withDefault();
    }

    public function translationFor(string $locale): ?ExtraChargeTranslation
    {
