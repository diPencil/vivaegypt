...
final class DestinationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('tourbooking::agent.destinations.index', compact('destinations'));
    }
    ...
    {
        return view('tourbooking::agent.destinations.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('agent.tourbooking.destinations.index')
    ...
    public function show(Destination $destination): View
    {
        ...
        return view('tourbooking::agent.destinations.show', compact('destination'));
    }
    ...
    {
        return view('tourbooking::agent.destinations.edit', compact('destination'));
    }
