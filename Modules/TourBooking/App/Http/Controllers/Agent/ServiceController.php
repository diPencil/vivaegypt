...
namespace Modules\TourBooking\App\Http\Controllers\Agent;
...
final class ServiceController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('tourbooking::agent.services.index', compact('services'));
    }
    ...
    public function create(): View
    {
        ...
        return view('tourbooking::agent.services.create', compact('serviceTypes', 'amenities', 'enum_languages', 'destinations'));
    }
    ...
    public function store(ServiceRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('agent.tourbooking.services.edit', ['service' => $service->id, 'lang_code' => admin_lang()])->with($notify_message);
    }
    ...
    public function show(Service $service): View
    {
        ...
        return view('tourbooking::agent.services.show', compact('service'));
    }
    ...
    public function edit(Request $request, Service $service): View
    {
        ...
        return view('tourbooking::agent.services.edit', compact('service', 'serviceTypes', 'translation', 'lang_code', 'amenities', 'enum_languages', 'destinations'));
    }
    ...
    public function destroy(Service $service): RedirectResponse
    {
        ...
        return redirect()->route('agent.tourbooking.services.index')->with($notify_message);
    }
    ...
    public function showItineraries(Service $service): View
    {
        ...
        return view('tourbooking::agent.services.itineraries', compact('service'));
    }
    ...
    public function showExtraCharges(Service $service): View
    {
        ...
        return view('tourbooking::agent.services.extra_charges', compact('service'));
    }
    ...
    public function showAvailability(Service $service): View
    {
        ...
        return view('tourbooking::agent.services.availability', compact('service'));
    }
    ...
    public function getByType(string $type): View
    {
        ...
        return view('tourbooking::agent.service_types.show', compact('serviceType', 'services'));
    }
    ...
    public function showMedia(Service $service): View
    {
        ...
        return view('tourbooking::agent.services.media', compact('service'));
    }
