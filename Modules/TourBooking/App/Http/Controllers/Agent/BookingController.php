...
final class BookingController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('tourbooking::agent.bookings.index', compact('bookings'));
    }
    ...
    public function create(): View
    {
        ...
        return view('tourbooking::agent.bookings.create', compact('services'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('agent.tourbooking.bookings.show', $booking)
    ...
    public function show(Booking $booking): View
    {
        ...
        return view('tourbooking::agent.bookings.details', compact('booking', 'extra_services'));
    }
    ...
    public function edit(Booking $booking): View
    {
        ...
        return view('tourbooking::agent.bookings.edit', compact('booking', 'services'));
    }
    ...
    public function destroy(Booking $booking): RedirectResponse
    {
        ...
        return redirect()->route('agent.tourbooking.bookings.index')->with($notify_message);
    }
    ...
    public function invoice(Booking $booking): View
    {
        ...
        return view('tourbooking::agent.bookings.invoice', compact('booking'));
    }
    ...
    public function downloadInvoicePdf(Booking $booking)
    {
        ...
        $pdf = PDF::loadView('tourbooking::agent.bookings.invoice', compact('booking'))
            ->setPaper('a4')
