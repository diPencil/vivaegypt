                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($reviews as $index => $review)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><a href="{{ dashboard_route('admin.user-show', $review->user_id) }}">{{ html_decode($review->user?->name) }}</a></h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ dashboard_route('admin.review-detail', $review->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('translate.Details') }}</a>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ dashboard_url("admin/listing/review-delete/") }}'+"/"+id)
        }
    </script>
@endpush
