                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch d-flex items-center justify-between create_new_btn_box">
                                        <div class="crancy-header__form crancy-header__form--customer create_new_btn_inline_box">
                                            ...
                                            <a href="{{ dashboard_route('admin.product.create') }}" class="crancy-btn "><span>
                                                ...
                                                <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                            ...
                                                            <li>
                                                                <a href="{{ dashboard_route('admin.product.edit', ['product_id' => $product->id, 'lang_code' => admin_lang()]) }}" class=" dropdown-item"><i class="fas fa-edit"></i> {{ __('translate.Edit') }}
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <a href="{{ dashboard_route('admin.product.gallery', $product->id) }}" class=" dropdown-item"><i class="fas fa-images"></i> {{ __('translate.Gallery') }}
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ dashboard_url("admin/ecommerce/product/delete") }}'+"/"+id)
        }
