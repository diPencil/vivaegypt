...
@section('body-header')
    <h3 class="crancy-header__title m-0">
        {{ isset($product) ? __('translate.Edit Product') : __('translate.Add New Product') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Product') }} >>
        {{ isset($product) ? __('translate.Edit Product') : __('translate.Add New Product') }}</p>
@endsection
...
@section('body-content')
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ dashboard_route('admin.product.edit', ['product_id' => $product->id, 'lang_code' => $language->lang_code]) }}">
    ...
    <form action="{{ dashboard_route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @if (admin_lang() == request()->get('lang_code'))
                                                                <div class="crancy__item-form--group mg-top-form-20">
                                                                    <label
                                                                        class="crancy__item-label">{{ __('translate.Slug') }}
                                                                        *</label>
                                                                    <input class="crancy__item-input" type="text"
                                                                        name="slug" id="slug"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div
                                                                            ...
                                                                            <label
                                                                                class="crancy__item-label">{{ __('translate.Is In Stock') }}
                                                                            </label>
                                                                            <div
                                                                                class="crancy-ptabs__notify-switch  crancy-ptabs__notify-switch--two">
                                                                                <label class="crancy__item-switch">
                                                                                    <input
                                                                                        {{ $product->is_in_stock == 1 ? 'checked' : '' }}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div
                                                                            class="crancy__item-form--group mg-top-form-20 ms-20">
                                                                            <label
                                                                                class="crancy__item-label">{{ __('translate.Is Best Selling') }}
                                                                            </label>
                                                                            <div
                                                                                class="crancy-ptabs__notify-switch  crancy-ptabs__notify-switch--two">
                                                                                <label class="crancy__item-switch">
                                                                                    <input
                                                                                        {{ $product->is_best_selling == 1 ? 'checked' : '' }}
                                                ...
                                                @if (admin_lang() == request()->get('lang_code'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('translate.Brand') }}
                                                                *
                                                            </label>
                                                            <select class="form-select crancy__item-input" name="brand_id"
                                                                id="brand_id">
                                                                <option value="" selected disabled>
                                                                    {{ __('translate.Select Brand') }}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('translate.Price') }}
                                                                *</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label
                                                                class="crancy__item-label">{{ __('translate.Offer Price') }}</label>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label
                                                                class="crancy__item-label">{{ __('translate.Tags') }}</label>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label
                                                            class="crancy__item-label">{{ __('translate.Specification') }}
                                                            *</label>
                                                        <textarea class="crancy__item-input crancy__item-textarea summernote" name="specification" id="specification">{{ old('specification', $listing_translate->specification ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">
                                                    {{ __('translate.SEO Information') }}</h4>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
