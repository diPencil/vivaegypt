...
@section('title')
    <title>{{ __('translate.Product Gallery') }}</title>
@endsection
                                ...
                                <div class="col-12 mg-top-30">
                                    ...
                                    <div class="crancy-product-card">
                                        ...
                                        <div class="row mg-top-30">
                                            <form id="dropzoneForm" method="post" action="{{ dashboard_route('admin.product.uploadGallery', $product->id) }}"  enctype="multipart/form-data"  class="dropzone">
                                                @csrf
                                            </form>
                                        ...
                                        <div class="gallery-img-item">
                                            @foreach ($galleries as $index => $gallery_image)
                                                <div class="gallery-img-item-thumb">
                                                    <img src="{{ asset($gallery_image->image) }}" alt="img">
...
@push('js_section')
    ...
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ dashboard_url("admin/ecommerce/product/delete-gallery/") }}'+"/"+id)
        }
    </script>
