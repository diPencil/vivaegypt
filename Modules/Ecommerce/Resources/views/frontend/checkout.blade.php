                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="product-total text-end"> {{ __('translate.Subtotal') }} </th>
                                            </tr>
                                        </thead>
                                        <tbody>
