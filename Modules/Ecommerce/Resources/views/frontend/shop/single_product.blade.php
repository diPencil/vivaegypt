...
@section('front-content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="vivaegypttravel-tab-slider mb-40" data-aos="fade-up" data-aos-duration="800">
                        @if (count($product->galleries) > 0)
                            <div class="vivaegypttravel-tabs-container">
                                <div class="vivaegypttravel-tabs-wrapper">
                            ...
                            <ul class="vivaegypttravel-tabs-menu">
                                @foreach ($product->galleries as $gallery)
                                ...
                                <span>
                                    <svg width="20" height="18" viewBox="0 0 20 18" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#C62828" stroke-width="1.4" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </span>
                                                    ...
                                                    <div class="tg-tour-about-review-form-wrap">
                                                        ...
                                                        <div class="tg-tour-about-review-form">
                                                            <form class="write_review_box_form" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <textarea name="reviews" id="reviews" class="textarea mb-20" placeholder="{{ __("translate.Write Message") }}"></textarea>
    ...
    <section class="related-product-area pb-100">
        <div class="container">
            <h2 class="tg-product-details-title mb-20 pb-20">{{ __('translate.Related Products') }}</h2>
            <div class="row">
    ...
    @push('style_section')
        ...
        <style>
            ...
            ul.vivaegypttravel-tabs-menu li.active a {
