...
Route::group(['as' => 'staff.', 'prefix' => 'staff/ecommerce', 'middleware' => ['MaintenanceMode', 'auth:web', 'CheckStaff', 'CheckStaffRoutePermission']], function () {
    Route::prefix('product')->controller(ProductController::class)->name('product.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::get('edit', 'edit')->name('edit');
        Route::get('edit/{product_id}', 'edit')->name('edit-by-id');
        Route::post('store/{id?}', 'store')->name('store');
        Route::put('update/{id}', 'update')->name('update');
        Route::put('status/{id}', 'status')->name('status');
        Route::get('gallery/{id}', 'gallery')->name('gallery');
