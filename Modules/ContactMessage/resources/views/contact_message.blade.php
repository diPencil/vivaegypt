                                            ...
                                            @foreach ($contact_messages as $index => $contact_message)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        ...
                                                        <a onclick="itemDeleteConfrimation({{ $contact_message->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn delete_danger_btn"><i class="fas fa-trash"></i> </a>
                                                        @endif
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ dashboard_url("admin/delete-contact-message/") }}'+"/"+id)
        }
    </script>
@endpush
