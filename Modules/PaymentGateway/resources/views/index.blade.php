...
{{-- 
 ...
 --}}
                                                ...
                                                <a class="list-group-item active" data-bs-toggle="list" href="#id2"
...
{{-- 
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id4"
                                                    ...
                                                    <h4 class="crancy-psidebar__title">{{ __('translate.Flutterwave') }}
                                                    </h4>
                                                </a>
 ...
 --}}
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id10"
                                                    role="tab" aria-selected="false"><span
                                                        class="crancy-psidebar__icon"><i class="fas fa-list    "></i>
                                                    </span>
                                                    <h4 class="crancy-psidebar__title">{{ __('translate.Paymob') }}</h4>
                                                </a>
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id9"
                                                    role="tab" aria-selected="false"><span
                                                        class="crancy-psidebar__icon"><i class="fas fa-list    "></i>
                                                    </span>
                                                    <h4 class="crancy-psidebar__title">{{ __('translate.Cash Payment') }}
                                                    </h4>
                                                </a>
...
{{-- 
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Currency') }}
                                                                                                    * </label>
                                                                                                <select
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Stripe Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Stripe Secret') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
 ...
 --}}
                                                    ...
                                                    <div class="tab-pane fade active show" id="id2" role="tabpanel">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Account Mode') }}
                                                                                                    * </label>
                                                                                                <select
                                                                                                    class="form-select crancy__item-input"
                                                                                                    name="account_mode">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Client Id') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Secret Id') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
...
{{-- 
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Razorpay Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Razorpay Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Secret Key') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Theme Color') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="color"
                                                    ...
                                                    <div class="tab-pane fade " id="id4" role="tabpanel">
                                                        <form action="{{ route('admin.update-flutterwave') }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Flutterwave Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="crancy__item-switch">
                                                                                                        <input
                                                                                                            {{ $payment_setting->flutterwave_status == 1 ? 'checked' : '' }}
                                                                                                            name="status"
                                                                                                            type="checkbox">
                                                                                                        <span
                                                                                                            class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                class="btn-check"
                                                                                                                name="image"
                                                                                                                id="input-img-flutterwave"
                                                                                                                autocomplete="off"
                                                                                                                onchange="flutterwavePreviewImage(event)">
                                                                                                            <label
                                                                                                                class="crancy-image-video-upload__label"
                                                                                                                for="input-img-flutterwave">
                                                                                                                <img id="view_flutterwave_img"
                                                                                                                    src="{{ asset($payment_setting->flutterwave_logo) }}">
                                                                                                                <h4
                                                                                                                    class="crancy-image-video-upload__title">
                                                                                                                    {{ __('translate.Click here to') }}
                                                                                                                    <span
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach ($currency_list as $currency)
                                                                                                        <option
                                                                                                            {{ $payment_setting->flutterwave_currency_id == $currency->id ? 'selected' : '' }}
                                                                                                            value="{{ $currency->id }}">
                                                                                                            {{ $currency->currency_name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Public Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    type="text"
                                                                                                    name="title"
                                                                                                    value="{{ $payment_setting->flutterwave_title }}">
                                                                                            </div>
                                                                                        </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Mollie Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="crancy__item-switch">
                                                                                                        <input
                                                                                                            {{ $payment_setting->mollie_status == 1 ? 'checked' : '' }}
                                                                                                            name="status"
                                                                                                            type="checkbox">
                                                                                                        <span
                                                                                                            class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                id="input-img-mollie"
                                                                                                                autocomplete="off"
                                                                                                                onchange="molliePreviewImage(event)">
                                                                                                            <label
                                                                                                                class="crancy-image-video-upload__label"
                                                                                                                for="input-img-mollie">
                                                                                                                <img id="view_mollie_img"
                                                                                                                    src="{{ asset($payment_setting->mollie_image) }}">
                                                                                                                <h4
                                                                                                                    class="crancy-image-video-upload__title">
                                                                                                                    {{ __('translate.Click here to') }}
                                                                                                                    <span
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    class="form-select crancy__item-input"
                                                                                                    name="mollie_currency_id">
                                                                                                    <option value="">
                                                                                                        {{ __('translate.Select') }}
                                                                                                    </option>
                                                                                                    @foreach ($currency_list as $currency)
                                                                                                        <option
                                                                                                            {{ $payment_setting->mollie_currency_id == $currency->id ? 'selected' : '' }}
                                                                                                            value="{{ $currency->id }}">
                                                                                                            {{ $currency->currency_name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Mollie Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Paystack Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Instamojo Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.API Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Auth Token') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
 ...
 --}}
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Bank Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Account Information') }}
                                                                                                    *</label>
                                                    ...
                                                    <div class="tab-pane fade " id="id9" role="tabpanel">
                                                        <form action="{{ route('admin.update-cash-payment') }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Cash Payment Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">Button
                                                                                                    Text * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                    ...
                                                    <div class="tab-pane fade" id="id10" role="tabpanel">
                                                        <form action="{{ route('admin.update-paymob') }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="crancy-ptabs__separate">
                                                                        <div class="crancy-ptabs__form-main">
                                                                            <div class="crancy__item-group">
                                                                                <h3 class="crancy__item-group__title">
                                                                                    {{ __('translate.Paymob Configuration') }}
                                                                                </h3>
                                                                                <div class="crancy__item-form--group">
                                                                                    <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="crancy__item-switch">
                                                                                                        <input
                                                                                                            {{ $payment_setting->paymob_status == 1 ? 'checked' : '' }}
                                                                                                            name="status"
                                                                                                            type="checkbox">
                                                                                                        <span
                                                                                                            class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                id="input-img-paymob"
                                                                                                                autocomplete="off"
                                                                                                                onchange="paymobPreviewImage(event)">
                                                                                                            <label
                                                                                                                class="crancy-image-video-upload__label"
                                                                                                                for="input-img-paymob">
                                                                                                                <img id="view_paymob_img"
                                                                                                                    src="{{ asset($payment_setting->paymob_image) }}">
                                                                                                                <h4
                                                                                                                    class="crancy-image-video-upload__title">
                                                                                                                    {{ __('translate.Click here to') }}
                                                                                                                    <span
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach ($currency_list as $currency)
                                                                                                        <option
                                                                                                            {{ $payment_setting->paymob_currency_id == $currency->id ? 'selected' : '' }}
                                                                                                            value="{{ $currency->id }}">
                                                                                                            {{ $currency->currency_name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Paymob API Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                                    name="api_key"
                                                                                                    value="{{ $payment_setting->paymob_api_key }}">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Paymob Iframe ID') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                                    name="iframe_id"
                                                                                                    value="{{ $payment_setting->paymob_iframe_id }}">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Paymob Integration ID') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                                    name="integration_id"
                                                                                                    value="{{ $payment_setting->paymob_integration_id }}">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('translate.Paymob HMAC') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                                    name="hmac"
                                                                                                    value="{{ $payment_setting->paymob_hmac }}">
                                                                                            </div>
                                                                                        </div>
...
@push('js_section')
    <script>
        ...
        function paymobPreviewImage(event) {
            var reader = new FileReader();
            reader.onload = function() {
                var output = document.getElementById('view_paymob_img');
                output.src = reader.result;
            }
